...
const NAV_ITEMS = [
    ...
    { icon: Zap, label: "ORDER CENTER", to: "/orders" },
        ...
        <>
            ...
            >
                ...
                <div className="h-16 flex items-center justify-center border-b border-white/5 px-4 shrink-0 relative">
                    ...
                    <button
                        onClick={onClose}
                        className="md:hidden absolute top-4 right-4 p-1 text-gray-500 hover:text-white rounded-md"
                    >
                        <X className="w-5 h-5" />
                    </button>
                </div>
              ...
              ${
                        ...
                        >
                            {({ isActive }) => (
                                <>
                                    ...
                                    <Icon
                                        className={`w-5 h-5 shrink-0 transition-all ${isActive ? "drop-shadow-[0_0_6px_rgba(0,243,255,0.7)]" : "group-hover:text-[var(--color-neon-cyan)]"}`}
                                    />
                ...
                {/* ── System Status ── */}
                <div
                    className={`border-t border-white/5 px-4 py-4 space-y-3 shrink-0 ${collapsed ? "px-2" : ""}`}
                >
                    {!collapsed && (
                    ...
                    {/* Link Status */}
                    <div
                        className={`flex items-center justify-between ${collapsed ? "justify-center" : ""}`}
                    >
                    ...
                    {/* Node / Backend Info */}
                    <div
                        className={`flex items-center justify-between ${collapsed ? "hidden" : ""}`}
                    >
                        <div className="flex items-center gap-2">
