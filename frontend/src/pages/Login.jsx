    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <motion.div
                ...
                className="w-full max-w-md bg-[#08080a] border border-[var(--color-neon-cyan)]/30 rounded-2xl p-8 relative z-20 shadow-[0_0_50px_rgba(0,243,255,0.1)]"
            >
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-black tracking-widest text-[var(--color-neon-cyan)] drop-shadow-[0_0_8px_rgba(0,243,255,0.5)]">
                        INSERT3COINS
                    </h1>
